...
/* harmony import */ var vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_3__);
...
var app = new (vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_3___default())({
  el: '#feedbackForm',
  data: {
  ...
  methods: {
    onSubmit: function onSubmit() {
      ...
      this.isLoading = true;
      this.form.post('/contact_us').then(function (response) {
        return _this.response = 'Thank you for contacting us!', _this.response = response.message, _this.nofity();
      })["catch"](function (err) {
...
$(function () {
  $(window).scroll(function () {
    if ($(this).scrollTop() > 100) {
      ...
      topheader.style.background = '#fff'; //topheader.style.background = '#343E13';
...
try {
  ...
  window.$ = __webpack_provided_window_dot_jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); //require('bootstrap');
} catch (e) {}
/**
...
var Errors = /*#__PURE__*/function () {
  ...
  _createClass(Errors, [{
    ...
    value: function record(errors) {
      this.errors = errors; //console.log('recorded: ');
