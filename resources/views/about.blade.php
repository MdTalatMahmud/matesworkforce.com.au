            ...
            <div id="nav">
                ...
                <div id="close_menu">&times;</div><!-- open -->
                  <ul class="menu_ul">
                      ...
                      <li class="m-p-n"><a href="{{route('requirement')}}">Employers</a> <i onclick="menuFunction()" id="arrow-m" class="fas fa-chevron-down"></i>
...
<div class="about-history">
   ...
   <div class="about-main">
        <p><strong>MATES WORKFORCE</strong> has been providing labour solutions for over 8 years. We understand that businesses need a flexible labour force to allow it to grow and develop. We are committed to providing both skilled and unskilled labour at short notice for periods of one day and more.</p>
   ...
   <div class="hand-img">
    ...
    <div class="container-tw container-padding">
         ...
         <div class="about-vision-body">
            ...
            <p>Our vision is to make Mates Workforce one of the best recruitment companies in Australia and provide labour solutions to international clients.</p>
...
<div class="part-of">
   ...
   <div class="container-tw container-padding">
      <div class="about-insights-header">
            ...
            <hr>
            <h2>Our Approach</h2>
            <p class="about-part-p">Our approach is to conduct our business in an honest and ethical manner by respecting all and considering our clients’ needs and employee abilities.</p>
       </div><!-- insights-header -->
