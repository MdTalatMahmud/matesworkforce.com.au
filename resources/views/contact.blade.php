        ...
        <div class="top-header">
            ...
            <div class="menu-d">
              <ul>
                <li><a href="/">Home</a></li>
                <li><a href="about">About Us</a></li>
                <li class="parent-menu"><a href="{{route('requirement')}}">Employers</a>
    ...
    <div class="container-tw container-padding">
            <div class="contact-block-f">
               ...
               <div class="location-design-one">
                    <ul>
                        ...
                        <li>Email: info@matesworkforce.com</li>
                    </ul>
                   <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d828.3739130824965!2d151.032701!3d-33.851115!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b12bcb1a7b9168b%3A0x9b513692dc17d3dd!2sLevel%201%2C%20Suite%2011%2F35-39%20Auburn%20Rd%2C%20Auburn%20NSW%202144%2C%20Australia!5e0!3m2!1sen!2sbd!4v1612701828958!5m2!1sen!2sbd" width="400" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                </div>
            </div>
            ...
            <div class="contact-block-f">
                ...
                <div class="location-design-input" id="feedbackForm">
                    ...
                    <div v-if="isLoading" class="notification warn">
                        Working...
                    </div>

                    <form method="post" action="{{ route('ContactUs_store') }}" @submit.prevent="onSubmit"  @keydown="form.errors.clear($event.target.name)">
                        @csrf
                        <div class="input-group">
                            <label for="name">Your Company Name:<span style="color:red">*</span></label><br>
                        ...
                        <div class="input-group">
                            <label for="email">Your Email Address:<span style="color:red">*</span></label><br>
                        ...
                        <div class="input-group">
                            ...
                            <textarea name="message" v-model="form.message" placeholder="Please message here..." cols="30" rows="5"></textarea>
