  ...
  <div class="insights-bg-d"></div><!-- insights-bg-d -->
      ...
      <div class="first-insights">
        ...
        <div class="first-insights-sec">
            <div class="pre-insights">
                ...
                <a href="{{route('requirement')}}#PRE-Employment"><button class="button-animation">Read more</button></a>
                </div>
        </div>
      </div>
    <div class="insight-sec-row">
      ...
      <div class="post">
        ...
        <a href="{{route('requirement')}}#Post-employment"><button class="button-animation">Read more</button></a>
      </div>
...
<div class="marketing-partner">
  ...
  <div class="marketing-partner-details">
    ...
    <p>Mates Workforce proven client approach process ensures we provide you the best labour solution for your business. By outsourcing this function to the Mates Workforce it allows your staff to focus on growing your business. We take on board responsibility right from the selection of a candidate to maintaining their pay and emoluments to that of their timely payment, pay roll services, Staff cover and welfare.</p>
      <p>Mates Workforces proven approach ensures that we provide our clients with the best labour solution. By outsourcing the recruitment process from us it allows owners to focus on growing their business and other important commitments.</p>
      <p>At Mates workforce we take the responsibility from the interviews and selection of the candidates to payroll services, staff cover and welfare.</p>
    <h2 class="m-bot-h"> <a href="{{route('contact')}}"><button>LET'S START A DISCUSSION <i class="fas fa-angle-right"></i></button></a> </h2>
